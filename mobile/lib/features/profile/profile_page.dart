...
class ProfilePage extends ConsumerWidget {
  ...
  Widget _buildMenuCard(BuildContext context, WidgetRef ref) {
    final items = [
      ...
      ('Kindle 设置', Icons.settings, () => _showKindleSettings(context)),
      ('帮助反馈', Icons.help_outline, () => _showHelpFeedback(context)),
      ('关于', Icons.info_outline, () => _showAbout(context)),
  ...
  void _showKindleSettings(BuildContext context) {
